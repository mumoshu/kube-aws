...
type etcdNodeImpl struct {
	cluster    EtcdCluster
	index      int
	config     clusterapi.EtcdNode
	subnet     clusterapi.Subnet
	natGateway clusterapi.NATGateway
}

func NewEtcdNodeDependsOnManagedNGW(cluster EtcdCluster, index int, nodeConfig clusterapi.EtcdNode, s clusterapi.Subnet, ngw clusterapi.NATGateway) EtcdNode {
	return etcdNodeImpl{
		cluster:    cluster,
		index:      index,
		config:     nodeConfig,
...
func NewEtcdNode(cluster EtcdCluster, index int, nodeConfig clusterapi.EtcdNode, s clusterapi.Subnet) EtcdNode {
	return etcdNodeImpl{
		cluster: cluster,
		index:   index,
		config:  nodeConfig,
...
func (i etcdNodeImpl) region() clusterapi.Region {
