...
func (p *Stack) RenderAddControllerUserdata(opts clusterapi.StackTemplateOptions) error {
...
func (p *Stack) RenderAddEtcdUserdata(opts clusterapi.StackTemplateOptions) error {
	return p.RenderAndAddUserData(
		"Etcd",
		p.EtcdTmplFile,
	)
...
func (p *Stack) RenderAddWorkerUserdata(opts clusterapi.StackTemplateOptions) error {
	return p.RenderAndAddUserData(
		"Worker",
		p.WorkerTmplFile,
	)
...
func (c *Stack) s3Folders() clusterapi.S3Folders {
	return clusterapi.NewS3Folders(c.S3URI, c.ClusterName)
}
...
func (c *Stack) GetUserData(id string) *clusterapi.UserData {
	id = strings.Title(id)
