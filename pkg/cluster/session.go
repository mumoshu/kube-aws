...
func (s *Session) ValidateStack(c *Stack) (string, error) {
...
func (s *Session) stackProvisioner(c *Stack) *cfnstack.Provisioner {
	stackPolicyBody := `{
  "Statement" : [
    {
       "Effect" : "Allow",
...
func (s *Session) InspectEtcdExistingState(c *Config) (clusterapi.EtcdExistingState, error) {
	var err error
	...
	state := clusterapi.EtcdExistingState{}
...
func (s *Session) lookupExistingEtcdEndpoints(c *Config) (string, error) {
